...
公司 LOGO 默认只允许 `scale`、`position`；`recolor_monochrome`、`opacity`、`external_shadow` 需逐项用户确认。始终禁止 `redraw`、`distort`、`change_letterforms`、`change_geometry`、`use_as_training_reference`。
